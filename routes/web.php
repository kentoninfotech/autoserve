...
// Account Backup
Route::get('/backup', [App\Http\Controllers\BackupController::class, 'index'])->name('backup')->middleware('role:AutoServe, AutoServe, Super,Admin');
// Backup all records
Route::post('/backup-all', [App\Http\Controllers\BackupController::class, 'backupAllRecords'])->name('backup.all')->middleware('role:AutoServe, AutoServe, Super,Admin');
// Route to download backup files
Route::get('/download-backup/{file}', [App\Http\Controllers\BackupController::class, 'downloadBackup'])->name('download.backup')->middleware('role:AutoServe, AutoServe, Super,Admin');
